function GalleryChildAssistant(args) {
...
GalleryChildAssistant.prototype.setup = function() {
	...
	this.commandMenuModel = {
		visible: true,
		items: [{},{},MenuData.CommandMenu.Back]
	}
...
GalleryChildAssistant.prototype.dividerFunc = function(itemModel) {
		return itemModel.main_category_name;
};

GalleryChildAssistant.prototype.aboutToActivate = function() {
...
GalleryChildAssistant.prototype.activate = function(event) {
...
GalleryChildAssistant.prototype.deactivate = function(event) {
...
GalleryChildAssistant.prototype.cleanup = function(event) {
	/* this function should do any cleanup needed before the scene is destroyed as 
	   a result of being popped off the scene stack */
	this.controller.stopListening('forumList', Mojo.Event.listTap, this.listTapHandler);
};

GalleryChildAssistant.prototype.handleCommand = function(event) {
	try {
		switch (event.type) {
			case Mojo.Event.command:
				switch (event.command) {
					case "go-recent":
						this.controller.stageController.popScenesTo("galleryHome");
...
GalleryChildAssistant.prototype.listTap = function(event) {
	...
	}, this.parentForum.child_list[item]);
	
};

GalleryChildAssistant.prototype.refreshScene = function() {
/*
...
GalleryChildAssistant.prototype.setupWaitingFeedback = function() {
	try {
		this.spinnerAttrs = {
...
GalleryChildAssistant.prototype.setWaitingFeedback = function(activate) {
	if (activate) {
		this.scrim.show();
...
GalleryChildAssistant.prototype._searchKey = function(event)
	{
...
GalleryChildAssistant.prototype._focusSearch = function(event)
	{
